...
#define WORK_ADDRESS      4 //Pink-тестовый приёмник на этом адресе!!
...
//МЕНЯТЬ:
/* Номер пина для измерения батарейки
Для «нормального» BSFrance и AdaFruit поставить 9
Для исправленного BSFrance (с резисторами) - поставить A1 или 19 (это одно и то же!)
*/
#define PIN_BATTERY 19 // 9  //A1  
/*Коэффициент делителя для измерения батарейки.
  Для «хорошего» BSFrance поставить 1.27;
