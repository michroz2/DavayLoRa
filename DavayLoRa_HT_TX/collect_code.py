# collect_code.py для сборки кода проекта DavayLoRa_HT_TX в Markdown файл

import os

# Настройки
PROJECT_NAME = "DavayLoRa_HT_TX"
VERSION = "1.72"
OUTPUT_FILE = f"DavayLoRa_HT_TX_Snapshot_v{VERSION}.md"
