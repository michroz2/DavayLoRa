...
#define WORK_ADDRESS 4 //TEST ADDRESS ==4
...
//после чего он самостоятельно выключается, даже если кнопка удерживается нажатой
//(в этом случае будет периодический сигнал в течение CUTOFF_TIME с паузой PING_TIMEOUT)
...
*/
#define BATTERY_VOLTAGE_MULTIPLIER 1.27

//============================//МЕНЯТЬ-ЗАКОНЧЕНО!=================================

#define PIN_BATTERY_NORMAL 9    //не трогать!
#define PIN_BATTERY_RESISTOR A1 //не трогать!
...
bool measurebattery = MEASURE_BATTERY; //initial value taken from define. Default = true
int batteryPIN = PIN_BATTERY;
